<template>
    <div class="container-form">
        ...
        <h1 :class="{ 'show-final': showFinal }">
            Thank you for the Information, {{ registerSteps[0].value }}, Now you
            can
            <router-link to="/login" class="btn-custom">Login</router-link>
        </h1>
        <div id="register">
...
export default {
    data: () => {
        return {
            ...
            registerSteps: [
                {
                    label: "What's your Bio?",
                    type: "text",
                    value: "",
                    pattern: /.+/
                },
                {
                    label: "What's your favourite thing number 1?",
                    type: "text",
                    value: "",
                    pattern: /.+/
                },
                {
                    label: "What's your favourite thing number 2?",
                    type: "text",
                    value: "",
                    pattern: /.+/
                },
                {
                    label: "What's your favourite thing number 3?",
                    type: "text",
                    value: "",
                    pattern: /.+/
                }
    ...
    methods: {
        ...
        checkStep() {
            if (
                !this.registerSteps[this.position].pattern.test(this.inputValue)
            ) {
        ...
        setProgress() {
            this.progress =
                (this.position / this.registerSteps.length) * 100 + "%";
        }
    },
    mounted() {
